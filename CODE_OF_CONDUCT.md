...
- Welcome newcomers and beginners — everyone starts somewhere
...
- Dismissing contributions because of the contributor's age or experience level
- Publishing private information about others without consent
- Any form of trolling or deliberately disruptive behavior

## Scope

This Code of Conduct applies in all project spaces — GitHub issues, pull requests, discussions, and the Discord server.
...
Maintainers reserve the right to remove comments, close issues, or ban contributors who violate this Code of Conduct.
